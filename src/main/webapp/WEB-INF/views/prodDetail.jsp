                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="./resources/main/img/product-single/product-1.jpg" alt="">
                                <div class="zoom-icon">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                <div class="breadcrumb-text product-more">
                                    <span>Atelier</span>
                                    <h3>상품명</h3>
                                    <a href="ATdetail" ><i class="fa fa-home"></i><span> 공방 Home</span></a>
                                </div>
                                <div class="pd-rating">
                                ...
                                <div class="pd-desc">
                                    <p>간략한 제품 소개는 여기다가</p>
                                    <h4>69,000 <span>74,000</span></h4>
                                </div>
                                <input type="button" class="primary-btn pd-cart" value="공방 구독하기" onclick=>
                                <hr>
                                <div class="pd-color">
                                    <h6>색상</h6>
                                ...
                                <ul class="pd-tags">
                                    <li><span>제품카테고리</span>: Ex) 지갑,가방,벨트 등등</li>
                                </ul>
                                <div class="pd-share">
                                ...
                                <div class="tab-pane fade-in active" id="tab-1" role="tabpanel">
                                    <div class="product-content">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img src="./resources/main/img/product-single/tab-desc.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="specification-table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p-stock">재고 : 22</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="p-catagory">무게</td>
                                                <td>
