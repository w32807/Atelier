...
<!-- 상단바 End -->
	...
	<!---------------------------------------------여기서 검색처리를 합니다. (검색어의 name은 search로 잡았습니다.-------------------------------------------->
					<div id="searchFrm" class="colorlib-heading animate-box" style="margin-left: 700px;">
                     <div class="advanced-search">
                        <div class="input-group"style="margin: 0px auto; margin-bottom: 100px; margin-right: 400px;">
                           <input id="keyword" type="text" name="search" placeholder="검색어를 입력 해 주세요."
                              style="width: 280px; padding-left: 8px; font-size: 14px; border: 1px solid #A09182;">
	...
	<!-------------------------------------------------여기까지 검색처리를 합니다.---------------------------------------------------------------------------->
					...
					<form action="ATOrder" method="get" name="orderFrm">
						<div class="row">
							<div class="col-md-6" style="left: 100px">

								<!--여기서부터 발주 신청을 할 수 있는 하나하나의 목록들이 출력 됩니다. foreach문으로 반복 해주면 될 것 같습니다-->
								<!-- 여기 1열에는 넘어온 물품 리스트 배열의 홀수 번째 index의 물품만 foreach 문으로 출력합니다. -->
								<!-- 이 품목의 check박스의 id,value, 단가의 id, 수량 input 태그의 name은 해당 상품의 상품코드를 넣어주세요. -->
								<!-- 이렇게하면, 체크된 체크박스들이 prod라는 이름의 배열에 담겨 배열의 값들은 상품코드가 됩니다. -->
								<!-- 그리고 모든 수량과 prod를 controller에 넘겨서, prod 배열에 존재하는 상품 코드로 수량의 값을 꺼내와 처리 할 것입니다. -->
								<!--foreach var="prod1" items=""-->
								<div class="colorlib-feature animate-box"
									...
									<label>
										...
										<div class="colorlib-text" style="padding: 13px 0 0 150px; font-size: 15px; font-weight: 400;">
											...
											<input id="상품코드1" type="checkbox" name="prod" value="상품코드1" ><br>
											<b>단가</b><span name="prodPrice" id="상품코드1">&nbsp;&nbsp;&nbsp;1000&#8361;</span><br>
											<b>수량</b>&nbsp;&nbsp;&nbsp;<input name="상품코드1"value="0"
												class="numOfprod" type="number" min="0"
												style="border: none; width: 70px;" placeholder="입력 ">
											<br> <b>색상</b><span>&nbsp;&nbsp;&nbsp;보라</span><br>
										</div>
									</label>
								</div>			
	<!-------------------------------------------- 여기까지가 하나하나의 목록입니다.------------------------------------------------>
								...
								<div class="colorlib-feature animate-box"
									...
									<label>
										...
										<div class="colorlib-text" style="padding: 13px 0 0 150px; font-size: 15px; font-weight: 400;">
											...
											<input id="상품코드2" type="checkbox" name="prod" value="상품코드2" ><br>
											<b>단가</b><span name="prodPrice" id="상품코드2">&nbsp;&nbsp;&nbsp;1000&#8361;</span><br>
											<b>수량</b>&nbsp;&nbsp;&nbsp;<input name="상품코드2"value="0"
												class="numOfprod" type="number" min="0"
												style="border: none; width: 70px;" placeholder="입력 ">
								...
								<div class="colorlib-feature animate-box"
									...
									<label>
										...
										<div class="colorlib-text" style="padding: 13px 0 0 150px; font-size: 15px; font-weight: 400;">
											...
											<input id="상품코드3" type="checkbox" name="prod" value="상품코드3" ><br>
											<b>단가</b><span name="prodPrice" id="상품코드3">&nbsp;&nbsp;&nbsp;1000&#8361;</span><br>
											<b>수량</b>&nbsp;&nbsp;&nbsp;<input name="상품코드3"value="0"
												class="numOfprod" type="number" min="0"
												style="border: none; width: 70px;" placeholder="입력 ">
											<br> <b>색상</b><span>&nbsp;&nbsp;&nbsp;보라</span><br>
										</div>
								...
								<div class="colorlib-feature animate-box"
									...
									<label>
										...
										<div class="colorlib-text" style="padding: 13px 0 0 150px; font-size: 15px; font-weight: 400;">
											...
											<input id="상품코드4" type="checkbox" name="prod" value="상품코드4" ><br>
											<b>단가</b><span name="prodPrice" id="상품코드4">&nbsp;&nbsp;&nbsp;1000&#8361;</span><br>
											<b>수량</b>&nbsp;&nbsp;&nbsp;<input name="상품코드4"value="0"
												class="numOfprod" type="number" min="0"
												style="border: none; width: 70px;" placeholder="입력 ">												
											<br> <b>색상</b><span>&nbsp;&nbsp;&nbsp;보라</span><br>
										</div>
								...
								<div class="colorlib-feature animate-box"
									...
									<label>
										...
										<div class="colorlib-text" style="padding: 13px 0 0 150px; font-size: 15px; font-weight: 400;">
											...
											<input id="상품코드5" type="checkbox" name="prod" value="상품코드5" ><br>
											<b>단가</b><span name="prodPrice" id="상품코드5">&nbsp;&nbsp;&nbsp;1000&#8361;</span><br>
											<b>수량</b>&nbsp;&nbsp;&nbsp;<input name="상품코드5"value="0"
												class="numOfprod" type="number" min="0"
												style="border: none; width: 70px;" placeholder="입력 ">
								...
								<div class="colorlib-feature animate-box"
									...
									<label>
										...
										<div class="colorlib-text" style="padding: 13px 0 0 150px; font-size: 15px; font-weight: 400;">
											...
											<input id="상품코드6" type="checkbox" name="prod" value="상품코드6" ><br>
											<b>단가</b><span name="prodPrice" id="상품코드6">&nbsp;&nbsp;&nbsp;1000&#8361;</span><br>
											<b>수량</b>&nbsp;&nbsp;&nbsp;<input name="상품코드6"value="0"
												class="numOfprod" type="number" min="0"
												style="border: none; width: 70px;" placeholder="입력 ">											
											<br> <b>색상</b><span>&nbsp;&nbsp;&nbsp;보라</span><br>
										</div>
				...
				<div class="colorlib-feature animate-box"
					...
					<span style="font-size: 20px;" id="totalPrice"></span>
						 <input class="payment" type="button" name="order" value="결제"
							style="width: 60px; height: 30px; border: none; font-size: 16px; color: white; background-color: #A09182; margin-right: -50px;">
				</div>
			</form>
		</div>
	</div>
		 ...
		 //검색어를 입력하고 검색 결과를 출력할 ajax 함수      
	      $("#search").click(function() {//검색 버튼을 누르면...
	         console.log($("#keyword").val());
	            ...
	            $.ajax({
	               url: "prodSearch",//컨트롤러의 어디로 보낼 거니
	               type: "get",//방식은?
	               ...
	               success: function(data) {
	                  //성공했을 시 처리
	                  //검색했을 때 상품 목록을 받아오는 foreach문과, 첫 페이지 로드시 제품을 출력하는 foreach문을 통일 해 주세요.
	               },
