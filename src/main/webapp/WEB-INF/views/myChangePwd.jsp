                    ...
                    <div class="login-form">
                        ...
                        <form name="test" action="#">
                            ...
                            <div class="group-input">
                                <label for="username">기존 Password를 입력해주세요. *</label>
                                <input type="text" id="username"  required>
                            </div>
                            <div class="group-input">
                                <label for="pass">변경할 Password를 입력해주세요. *</label>
                                <input type="text" name= "a"  id="username"  required onblur=checkvalue();>
                            </div>
                            <div class="group-input">
                                <label for="username">변경할 Password를 재입력 해주세요.*</label>
                                <input type="text"  name= "b" id="username" required onblur=checkvalue();>
                            </div>
                            ...
                            <button type="submit" class="site-btn login-btn" onclick="javascript:btn()">비밀번호 변경하기</button>
                        </form>
