...
public class AT_Service {
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---- 기능: 공지사항 작성 작성자: KJH 작성일 : 2020.02.10 최종수정일 : 2020.02.11
	 * -----------------------------------------------------------------------------
	 * ------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---- 기능: 공지사항 출력 작성자: KJH 작성일 : 2020.02.10 최종수정일 : 2020.02.13
	 * -----------------------------------------------------------------------------
	 * ------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---- 기능: 공지사항 세부내용 출력 작성자: KJH 작성일 : 2020.02.10 최종수정일 : 2020.02.13
	 * -----------------------------------------------------------------------------
	 * ------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---- 기능: 공지사항 삭제 작성자: KJH 작성일 : 2020.02.10 최종수정일 : 2020.02.13
	 * -----------------------------------------------------------------------------
	 * ------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---------- 기능: 공방의 리스트를 출력 작성자: 정성규 작성일: 2020.02.10
	 * -----------------------------------------------------------------------------
	 * ------------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---------- 기능: 공방에서 만든 상품의 리스트를 출력 작성자: 정성규 작성일: 2020.02.10
	 * -----------------------------------------------------------------------------
	 * ------------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---------- 기능: 공방 정보 수정 작성자: 정성규 작성일: 2020.02.10
	 * -----------------------------------------------------------------------------
	 * ------------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---------- 기능: 마이페이지 수정 서비스 / 프로필 이미지 업로드 수정자 : JSG 작성자: JSH 작성일: 2020.02.05
	 * -----------------------------------------------------------------------------
	 * ------------
	 */
	...
	/*
	 * -----------------------------------------------------------------------------
	 * ---------- 기능: 회원 정보 / 프로필 사진 출력 수정자 : JSG 작성자: JSH 작성일: 2020.02.06
	 * -----------------------------------------------------------------------------
	 * ------------
	 */
