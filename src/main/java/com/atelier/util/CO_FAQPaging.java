...
public class CO_FAQPaging {
	...
	private int FAQPageNum; //현재 페이지 번호
	...
	private String makeHtml(int totalPage, int currentGroup) {
		...
		//<a href = list?FAQPageNum=5>[이전]</a>  ---- 6번 페이지에 있을 때, 이전을 눌러 5번페이지로 넘어가도록 만들기.
			for(int i = start; i<=end;i++) {
				if(FAQPageNum != i) {//현재 보고 있는 페이지가 아니라면 페이지 번호에 링크걸자
		...
		//<a href = list?FAQPageNum=6>[6]</a>  ---- 6번 페이지에 있을 때, 6번 표시
        //	<font style = 'color:red'>[7]</font>				
		//<a href = list?FAQPageNum=8>[8]</a>  ---- 8번 페이지에 있을 때, 8번 표시
			}
			...
			//<a href = list?FAQPageNum=11>[다음]</a>
